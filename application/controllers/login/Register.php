...
class Register extends MY_Controller
{
	...
	public function createBayarInAnggotaLogin()
	{
		...
		if (!$this->upload->do_upload('fileSaya')) {
			...
			$this->LoginModel->saveBayarAnggota($anggota);
			flashMessage('success', 'Registrasi anggota SMAIKA3BDG berhasil! Silahkan tunggu verifikasi dari pihak admin sebagai pengelola.');
			redirect('anggota/Anggota/kelolaAnggota', $anggota);
		}
	}
}
