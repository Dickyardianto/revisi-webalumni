...
<ul class="breadcrumb">
    <li>Anggota</li>
    <li class="active"><a href="<?= base_url('admin/Anggota/kelolaAnggota'); ?>">Kelola Anggota</a></li>
</ul>
<!-- END BREADCRUMB -->
            ...
            <form action="<?= base_url('admin/anggota/setUpdateFoto'); ?>" class="form-horizontal" id="ubah-foto-anggota-validate" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="margin-left: 10px; margin-top: 12px;">
                        ...
                        <input type="hidden" class="form-control" id="ubahFotoAnggota" name="ubahFotoAnggota" />
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-delete-anggota">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('admin/Anggota/hapusAnggota'); ?>" class="form-horizontal" method="post">
...
<script>
    ...
    $(".btn-ubah-anggota").click(function() {
        ...
        $.get('<?= base_url("admin/Anggota/getAnggotaById/") ?>' + idAnggota, function(data, success) {
            console.log(data);
            var data_obj = JSON.parse(data);
    ...
    $(".btn-hapus-anggota").click(function() {
        ...
        $.get('<?= base_url("admin/Anggota/getAnggotaById/"); ?>' + idAnggota, function(data) {
    ...
    $(".btn-detail-anggota").click(function() {
        console.log(this.id);
        var idAnggota = this.id;
        $(".btn-detail-anggota").attr("href", '<?= base_url("admin/Anggota/detailAnggota/"); ?>' + idAnggota);
    });
