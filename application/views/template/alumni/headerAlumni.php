        ...
        <div class="page-sidebar page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                ...
                <li class="xn-profile">
                    ...
                    <div class="profile">
                        ...
                        <div class="profile-data">
                            ...
                            <div class="profile-data-title">Alumni</div>
                        </div>
                    </div>
                </li>
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        <li><a href="<?= base_url('alumni/Komunitas') ?>"><span class="fa fa-cube"></span>Kelola Komunitas</a></li>
                ...
                <li class="hidden">
                    <a href="<?= base_url('alumni/Forbis'); ?>"><span class="glyphicon glyphicon-file"></span> <span
                            class="xn-text">Forum Bisnis</span></a>
                </li>
