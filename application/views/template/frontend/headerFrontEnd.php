                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown" style="margin-right: 20px;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?= base_url($info[0]->role); ?>">Beranda <span
                                        class="glyphicon glyphicon-stats pull-right"></span></a></li>
                            <?php else : ?>
                            <li><a href="<?= base_url($info[0]->role); ?>">Profil <span
                                        class="glyphicon glyphicon-stats pull-right"></span></a></li>
                            <li><a href="<?= base_url($info[0]->role) . '/pengaturan'; ?>">Pengaturan <span
                                        class="glyphicon glyphicon-cog pull-right"></span></a></li>
                            <?php endif; ?>
                            <li><a href="<?= base_url('login/Logout'); ?>">Log Out <span
