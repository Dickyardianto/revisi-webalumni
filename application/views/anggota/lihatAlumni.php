...
<ul class="breadcrumb">
    <li>Alumni</li>
    <li class="active"><a href="<?= base_url('anggota/Anggota/lihatAlumni'); ?>">Lihat Alumni</a></li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <p>Cari Alumni</p>
                        <form action="<?= base_url('anggota/Anggota/cariAlumni'); ?>" method="post">
                            <div class="col-md-12">
...
<script>
    $(".btn-detail-anggota").click(function() {
        ...
        $(".btn-detail-anggota").attr("href", '<?= base_url("anggota/Anggota/detailAlumni/"); ?>' + idAnggota);
    });
</script>