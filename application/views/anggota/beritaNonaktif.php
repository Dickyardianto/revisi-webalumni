...
<ul class="breadcrumb">
    ...
    <li><a href="<?= base_url('anggota/Berita/beritaNonaktif'); ?>">Berita Nonaktif</a></li>
</ul>
<!-- END BREADCRUMB -->
            ...
            <form action="<?= base_url('anggota/Berita/hapusBerita'); ?>" class="form-horizontal" method="post">
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        ...
                        <a href="<?= base_url('anggota/Berita/beritaNonaktif'); ?>" class="btn btn-default btn-lg">Batal</a>
                    </div>
                </div>
            </form>
        </div>
