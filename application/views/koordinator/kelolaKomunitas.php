...
<ul class="breadcrumb">
    <li>Komunitas</li>
    <li class="active"><a href="<?= base_url('koordinator/Komunitas'); ?>">Kelola Calon Komunitas</li></a>
</ul>
<!-- END BREADCRUMB -->
                                            ...
                                            foreach ($calonKomunitas as $CA) { ?>
                                                <?php if ($CA->stat_komunitas == 0) : ?>
                                                    <tr id="trow_1">
                                                        ...
                                                        <?php } else { ?>
                                                            <td><img src="<?= base_url('uploads/content/komunitas/' . $CA->logo_komunitas); ?>" alt="<?= $CA->nama_komunitas; ?>" title="<?= $CA->nama_komunitas; ?>" width="80" height="80" />
                                                            </td>
                                                        <?php } ?>
...
<div class="message-box animated zoomIn" data-sound="alert" id="message-box-terima">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Komunitas/aktivasiCalonKomunitas'); ?>" class="form-horizontal" method="post">
                <div class="mb-content">
                    <div class="panel-body">
                        <p>Apakah benar bahwa Komunitas di bawah ini akan diaktifkan sebagai Komunitas Aktif di
                            IKASMA3BDG
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        ...
                        <a href="<?= base_url('koordinator/Komunitas'); ?>" class="btn btn-default btn-lg mb-control-close">Batal</a>
                    </div>
                </div>
            </form>
        </div>
...
<div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-tolak">
    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <form action="<?= base_url('koordinator/Komunitas/tolakCalonKomunitas'); ?>" class="form-horizontal" method="post">
                <div class="mb-content">
                    <div class="panel-body">
