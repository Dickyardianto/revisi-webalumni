...
<ul class="breadcrumb">
    <li>Anggota</li>
    <li><a href="<?= base_url('koordinator/anggota'); ?>">Kelola Calon Anggota</li></a>
    <li><a href="<?= base_url('koordinator/anggota'); ?>">Tambah Calon Anggota</li></a>
    <li class="active">Pembayaran Anggota</li></a>
</ul>
<!-- END BREADCRUMB -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <form action="<?= base_url('login/Register/createBayarInKoordinatorLogin'); ?>" class="form-horizontal" id="form-tambah-berita-validate" method="post" enctype="multipart/form-data">
                            <div class="col-md-8">
