...
<div class="modal animated zoomIn" id="modal_data_diri" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('koordinator/Profile/setUpdateDataDiri') ?>" class="form-horizontal" id="data-diri-validate" method="post">
...
<!-- MODALS DOMISILI -->
<div class="modal zoomIn modal-info" id="modal_domisili" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form action="<?= base_url('koordinator/Profile/setUpdateDomisili') ?>" id="domisili-validate" class="form-horizontal" method="post">
                <div class="modal-body">
                    <div class="form-group hidden">
                        <div class="col-md-9">
...
<!-- MODALS PROFESI -->
<div class="modal zoomIn" id="modal_profesi" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form action="<?= base_url('koordinator/Profile/setUpdateProfesi') ?>" id="profesi-validate" class="form-horizontal" method="post">
                <div class="modal-body">
                    <div class="form-group hidden">
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">* Status Bekerja :</label>
                        <div class="col-md-9">
                            <select class="validate[required] select form-control" name="statusBekerja" id="statusBekerjaModal" onchange="statusBekerjaChange()">
                                <option value="">Pilih</option>
