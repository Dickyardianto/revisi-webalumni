...
<ul class="breadcrumb">
    ...
    <li class="active"><a href="<?= base_url('koordinator/ForumBisnis/kelolaCalonForBis'); ?>">Kelola Calon Forum
            Bisnis</a>
    </li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="message-box animated zoomIn" data-sound="alert" id="message-box-terima">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <form action="<?= base_url('koordinator/ForumBisnis/aktivasiCalonForBis'); ?>" class="form-horizontal" method="post">
        ...
        <div class="message-box message-box-danger animated zoomIn" data-sound="alert" id="message-box-tolak">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <form action="<?= base_url('koordinator/ForumBisnis/tolakCalonForBis'); ?>" class="form-horizontal" method="post">
                        <div class="mb-content">
                            <div class="panel-body">
